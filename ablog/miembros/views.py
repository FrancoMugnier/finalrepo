...
class EditProfilePageView(generic.UpdateView):
    ...
    fields=['user', 'bio', 'profile_pic', 'website_url', 'facebook_url', 'instagram_url']
...
class registro_usuario_View(generic.CreateView):
    form_class=SingUpForm
    template_name='registration/registrarse.html'
    success_url=reverse_lazy('login')

class editar_usuario_View(generic.UpdateView):
